...
const getAllCommentsByReviewerId = async (req, res) => {
    try {
        const { reviewerId } = req.params;
        
        const comments = await commentModel.getAllCommentsByReviewerId(reviewerId);
...
module.exports = { createComment, getTopComment, getChildComment, getAllComments, deleteComments, getCommentsByReviewerId, getAllCommentsByReviewerId}